...
map<const string*, Drawable*> GraphicsProcessing::screen_map;
...
void GraphicsProcessing::add_screen(Drawable* screen, const string* screen_id) {
    screen_map.insert({screen_id, screen});
}
Drawable* GraphicsProcessing::get_screen(const string* screen_id) {
